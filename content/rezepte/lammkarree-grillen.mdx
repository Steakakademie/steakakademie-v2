...
steps:
  ...
  - title: Ruhen und servieren
    ...
    duration: PT10M
    tip: "Profi-Tipp: Mit Fleur de Sel erst auf dem Teller abschließen — grobes Salz auf der fertigen Tranche bringt Textur und einen klaren Salzimpuls."
...
**Smoky Finish:** In der indirekten Phase einen Chunk [Kirschholz](/glossar/kirschholz) auf die Glut legen. Lamm nimmt Rauch sehr gut auf, Kirsche liefert eine fruchtige Note, die den kräftigen Eigengeschmack abrundet, statt ihn zu überlagern. Ein Chunk reicht für die gesamte indirekte Phase — mehr Holz drückt die Kräuterkruste ins Bittere. Wer es kräftiger mag, nimmt Buche; Hickory oder Mesquite sind für Lamm zu dominant.
